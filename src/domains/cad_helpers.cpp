...
/// @cond
template mm::Vec<double, 3> mm::cad_helpers::evaluate_b_spline(const double& t, int p,
        const Range<Vec<double, 3>>& control_points, const Range<double>& knots, int k);
template mm::Vec<double, 2> mm::cad_helpers::evaluate_b_spline(const double& t, int p,
